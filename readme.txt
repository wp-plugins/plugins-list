...
By default all output will be cached for 1 hour, ensuring that performance is impacted as little as possible. Use the parameter `cache` to change the number of hours. Set this to `No` to switch off caching.
