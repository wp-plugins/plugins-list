...
Tags: plugin,list,display,show,installed,blog
...
**Artiss Plugins List is the plugin *Plugins List*, authored by [nutsmuggler](http://profiles.wordpress.org/nutsmuggler/ "nutsmuggler"), brought up to date. Further enhancements are planned, including caching and widget support.**
